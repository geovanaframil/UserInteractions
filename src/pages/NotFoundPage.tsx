  ...
  return (
    <div className="rounded-xl border border-slate-800 bg-slate-900/80 p-4 shadow-lg shadow-slate-950/40 sm:p-6">
      ...
      <div className="mt-4">
        <Link
          to="/users"
          className="inline-flex w-full items-center justify-center rounded-lg bg-indigo-600 px-4 py-2.5 text-sm font-semibold tracking-wide text-white transition-all duration-200 hover:bg-indigo-500/95 hover:shadow-md sm:w-auto"
        >
          Voltar
        </Link>
      </div>
